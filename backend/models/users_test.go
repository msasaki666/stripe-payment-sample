...
var (
	userDBTypes = map[string]string{`ID`: `integer`, `Name`: `character varying`, `Email`: `character varying`, `Password`: `character varying`, `CreatedAt`: `timestamp without time zone`}
	_           = bytes.MinRead
)
